...
class SaleOrderLine(models.Model):
	...
	order_payment_acquirer_id = fields.Many2one("payment.acquirer", related="order_id.payment_acquirer_id", string="Payment Acquirer")
	order_payment_tx_id = fields.Many2one("payment.transaction", related="order_id.payment_tx_id", string="Transaction")
