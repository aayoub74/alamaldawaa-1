...
class SellerPaymentWizard(models.TransientModel):
    ...
    def _get_payment_method(self):
        ...
        return seller_id.payment_method.ids[0] if seller_id.payment_method else False
    ...
    seller_id = fields.Many2one(
        "res.partner", string="Seller", default=_get_seller, domain=[("seller", "=", True)])
    amount = fields.Float(string="Payment Amount")
    cashable_amount = fields.Float(
        string="Payment Amount", compute="get_cashable_amount")
